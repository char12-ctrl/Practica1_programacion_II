...
public class GestorServeisGimnas {
    ...
    public static void main(String[] args) {
        ...
        // >> La mida total de les pistes del gimnÃ s Club Esportiu Mediterrani és de X m^2
        //--------------------------------------------------------------------------------------------------------------------
        // Per completar:
        ...
        // >> El número total de serveis del gimnás és X dels quals X serveis estan operatius.
        //--------------------------------------------------------------------------------------------------
        // Per completar:
        System.out.println("El número total de serveis del gimnàs Club Esportiu Mediterrani és de " + clubMediterrani.getNumServeis() + " del quals "+clubMediterrani.calculServeisOperatius() +" serveis estan operatius.\n");


    }

    /**
     * MÃ¨tode de classe per afegir pistes de tenis, pistes de futbol, sales de fitness i socis al gimnàs.
    ...
    private static void ferReserves(Gimnas gim){
        ...
        //Intentar afegir la reserva amb la informaciÃ³ indicada i si no Ã©s possible mostrar el missatge d'error
        ...
        // Crear una LocalDateTime per definir la data i hora de la reserva.
        dateTime = LocalDateTime.of(2024, 2, 25, 10, 00);
        try {
            gim.afegirReserva(idServei, dni, dateTime);
        } catch (ExcepcioReserva e){
            System.out.println(e.getMessage());
